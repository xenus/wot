...
/**/
    ...
    "labels": {
      "mapSize": {
        ...
        "offsetX": 0,
        "offsetY": 0,
        "shadow": { "alpha": 80, "angle": 0, "blur": 8, "color": "0xAAAAAA", "distance": 0, "enabled": true, "strength": 4 },
        "width": 100
      },
      "nickShrink": 5,
      "units": {
        ...
        "css": {
          ...
          "lost": ".mm_l{font-family:$FieldFont; font-size:8px; color:#FCA9A4;} .mm_lclass{font-family:Arial; font-size:17px; color:#FCA9A4;}",
          ...
          "squad": ".mm_s{font-family:$FieldFont; font-size:8px; color:#FFD0B2;}",
        ...
        "format": {
          ...
          "lost": "<span class='mm_lclass'>{{vehicle-class}}</span><span class='mm_l'><i>{{vehicle-type}}</i></span>",
