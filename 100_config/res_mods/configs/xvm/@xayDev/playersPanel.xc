 ...
 */
{
  ...
  "playersPanel": {
    ...
    "short": {
      ...
      "extraFieldsLeft": [
        { "x": 57, "y": 5, "valign": "bottom", "align": "left", "format": "<img src='xvm://res/hp{{alive?_bg|_none}}.png' width='80' height='4'>"},
        { "x": 58, "y": 4, "valign": "bottom", "align": "left", "format": "<img src='xvm://res/hp{{squad?_s|{{alive?_g|_none}}}}.png' width='{{hp-ratio:78}}' height='2'>" },
//        { "x": 58, "y": 4, "valign": "bottom", "align": "left", "format": "<img src='xvm://res/hp{{alive?_g|_none}}.png' width='{{hp-ratio:78}}' height='2'>" },
//hp-{{squad?squad|ally}}-{{alive}}.png
//hp{{squad?_s|{{alive?_g|_none}}}}
      ...
      // Набор форматов для правой панели (поддерживается расширенный формат, см. выше)
      "extraFieldsRight": [
        { "x": 140, "y": 5, "valign": "bottom", "align": "left", "format": "<img src='xvm://res/hp_bg.png' width='80' height='4'>", "alpha": "{{alive?100|0}}"},
        { "x": 139, "y": 4, "valign": "bottom", "align": "left", "format": "<img src='xvm://res/hp_r.png' width='{{hp-ratio:78}}' height='2'>", "alpha": "{{alive?100|0}}"},
