 ...
 */
{
  ...
  "def": {
    ...
    "xn_hpBarBG": {
      ...
      "y": 22,
      "bindToIcon": true,
//      "format": "<img src='xvm://res/hp{{alive?_bg|_none}}.png' width='80' height='4'>"
      "alpha": "{{alive?100|0}}",
      "format": "<img src='xvm://res/hp_bg.png' width='80' height='4'>"
    },
    "xn_hp": {
      "x": 1,
      "y": 23,
      "bindToIcon": true,
//      "format": "<img src='xvm://res/hp{{squad?_s|{{alive?_g|_none}}}}.png' width='{{hp-ratio:78}}' height='2'>" 
//hp{{squad?_s|{{alive?_g|_none}}}}
//{{ally?{{squad?_s|_g}}|_r}}
      "alpha": "{{alive?100|0}}",
      "format": "<img src='xvm://res/hp{{ally?{{squad?_s|_g}}|_r}}.png' width='{{hp-ratio:78}}' height='2'>"
    }
  },
  // Parameters of the Players Panels ("ears").
  // Параметры панелей игроков ("ушей").
  "playersPanel": {
    ...
    "short": {
      ...
      "vehicleIconXOffsetLeft": -62,
      "vehicleIconXOffsetRight": -62,
